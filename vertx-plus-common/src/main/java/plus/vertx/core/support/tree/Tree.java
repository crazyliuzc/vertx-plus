...
import plus.vertx.core.support.TreeUtil;
...
public class Tree<T> extends LinkedHashMap<String, Object> implements Node<T> {
    ...
    public Tree(TreeNodeConfig treeNodeConfig) {
        super();
        this.treeNodeConfig = (null == treeNodeConfig) ? TreeNodeConfig.DEFAULT_CONFIG : treeNodeConfig;
    }
    ...
    public void putExtra(String key, Object value) {
        Preconditions.checkNotNull(key, "Key must be not empty !");
        this.put(key, value);
    }
}
